...
const strings = {
  en: {
    ...
    reset: 'reset sensors',
    resetting: 'resetting…',
    resetDone: 'neutral position set',
    resetHint: 'hold the phone the way you want to hold it, then reset — that pose becomes the new neutral.',
  ...
  de: {
    ...
    reset: 'sensoren zurücksetzen',
    resetting: 'setze zurück…',
    resetDone: 'nulllage gesetzt',
    resetHint: 'halte das handy so, wie du es halten willst, und drück zurücksetzen — diese haltung wird die neue nulllage.',
  ...
  ja: {
    ...
    reset: 'センサーをリセット',
    resetting: 'リセットしています…',
    resetDone: '基準の姿勢を設定しました',
    resetHint: '持ちたい向きでスマートフォンを構えてから、リセットを押してください。その姿勢が新しい基準になります。',
