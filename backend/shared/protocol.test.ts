...
assert.equal(camArgs({ t: 0, ft: 0, fps: 25, count: 1, clusters: [], people: [], spread: 0, energy: 0, cx: 0.5, cy: 0.5, armsUp: 0, flowX: 0, flowY: 0, turbulence: 0, moveSync: 0, converge: 0, nearest: 0, stillness: 0, occupancy: 0, flow: [], density: [], flowEnergy: 0, flowCoherence: 0, flowCx: 0.5, flowCy: 0.5, beat: 0, beatStrength: 0, densityMean: 0, largestShare: 0, mode: 'field' }, 1).map(tagOf).join(''), typeTags(CAM_FIELDS), '/hive/cam args must match CAM_FIELDS');
